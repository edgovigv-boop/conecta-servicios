...
function render() {
  ...
  $('toggleControlsBtn').textContent = $('controlsPanel').classList.contains('collapsed') ? 'Mostrar controles' : 'Ocultar controles';
  renderEvents();
}
...
function bind() {
  ...
  $('cleanModeBtn').addEventListener('click', cleanMode);
