...
const PWA_VERSION = "v4.9.38-asistente-negocio-configurable";
...
const MEMBER_ACCESS_MY_PUBLICATIONS_VERSION_V49362 = "4.9.38-asistente-negocio-configurable";
...
// ------------------------------------------------------------------
const BUSINESS_CHAT_MEMBERSHIP_VERSION_V49368 = "4.9.38-asistente-negocio-configurable";
...
(function businessMessagingV4937(){
  ...
  function renderConfigPage(context = {}) {
    ...
    root.innerHTML = `
      ...
      <span class="bm-kicker-v4937">v4.9.38 · Asistente de negocio</span>
