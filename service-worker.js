...
const CACHE_NAME = "conecta-servicios-v4.9.24-plus-asistente-templates";
const ASSETS = [
  "./",
  "index.html",
  "styles.css?v=4.9.24-plus-asistente-templates",
  "app.js?v=4.9.24-plus-asistente-templates",
  "manifest.json",
