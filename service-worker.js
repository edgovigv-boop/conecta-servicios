const CACHE_NAME = 'conecta-servicios-v6-3-21-video-10min-1gb';
...
const ASSETS = [
  ...
  '/manifest.json?v=6.3.21-video-10min-1gb',
...
self.addEventListener('fetch', event => {
  ...
  const networkFirst =
    ...
    url.search.includes('v=6321') ||
    url.search.includes('v=6.3.21');
