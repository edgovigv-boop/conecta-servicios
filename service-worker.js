...
const CACHE_NAME = "conecta-servicios-v4.9.21-home-feed-plantillas-reales";
const ASSETS = [
  "./",
  "index.html",
  "styles.css?v=4.9.21-home-feed-plantillas-reales",
  "app.js?v=4.9.21-home-feed-plantillas-reales",
  "manifest.json",
